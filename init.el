...
;; ruby
(add-to-list 'exec-path (expand-file-name "~/.gem/ruby/2.4.0/bin"))
(use-package enh-ruby-mode
  :commands enh-ruby-mode
  :init (add-hook 'enh-ruby-mode-hook 'eldoc-mode))
(use-package robe
  :after (enh-ruby-mode)
  :commands robe-mode
